...
5. You can open folder `notebooks/` directly inside VS Code and run:
    1) first the notebook [generate_fake_data](notebooks/generate_fake_data.ipynb) to generate data that mimicks the real data used in our paper (in particular Fast Drug Pharmacoscopy data and single-cell RNA data).
